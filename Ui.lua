...
local BuildInfo = loadstring(game:HttpGet"https://raw.githubusercontent.com/VSUDEVELOPMENTS/VSU-PROJECTS/refs/heads/main/build.lua")()
...
function Neverlose_Main:Window(config)
    ...
    --[[
        ...
        spawn(function()task.wait(.5)Neverlose_Main:AutoJoinDiscord("ddqHv4NDF5")end)
    ...
    function TabsSec:TSection(title)
        ...
        function Neverlose_Main:LastConfigSaved()
            if isfile(Folder1.."/LastLoaded.txt") then
                ...
                Neverlose_Main:Notify({Title = "DHC Raper 💸",
